...
import { firstLanding, findRoute } from '../src/cat-world.js';
import { scanContour, contactAt, standingHeight } from '../src/cat-surfaces.js';
import { groundedPaw } from '../src/cat-pose.js';
